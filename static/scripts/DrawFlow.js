...
function drawFlow() {
  ...
  var curve = svg.append('g').append("path")
            // Plot the area
  curve
                .attr("class", "mypath")
                .datum(data)
            ...
            // Add the brushing
              ...
              function updateBrush(){
                  ...
                  if(!extent){
                    ...
                    x.domain([25240, 72091])
                  }else{
                    x.domain([ x.invert(extent[0]), x.invert(extent[1]) ])
                    curve.select(".brush").call(brush.move, null) // This remove the grey brush area as soon as the selection has been done
                  }
